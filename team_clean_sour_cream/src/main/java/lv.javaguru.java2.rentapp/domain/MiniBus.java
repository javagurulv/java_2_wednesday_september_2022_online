...
public class MiniBus extends Vehicle {
    ...
    public MiniBus(String brand, String model, boolean isAvailableForRent, int yearOfProduction,
                   Colour colour, double rentPricePerDay, EngineType engineType, String plateNumber,
                   TransmissionType transmissionType, int passengerAmount, int baggageAmount, int doorsAmount, boolean isAirConditioningAvailable) {
