...
@Getter
public class AddPassengerCarRequest extends AddVehicleRequest{
    private int passengerAmount;
    private int baggageAmount;
    private int doorsAmount;
    private boolean isAirConditioningAvailable;

    public AddPassengerCarRequest(String brand, String model, boolean isAvailableForRent, int yearOfProduction,
