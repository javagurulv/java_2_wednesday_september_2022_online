...
public enum AppointmentValidationResult {
    ...
    APPOINTMENT_PAGENUMBER_MUST_BE_GREATER_THAN_ZERO,
    APPOINTMENT_PAGESIZE_MUST_BE_GREATER_THAN_ZERO,
    APPOINTMENT_PAGESIZE_AND_PAGENUMBER_MUST_NOT_BE_EMPTY,
    APPOINTMENT_PAGESIZE_AND_PAGENUMBER_MUST_NOT_BE_ZERO,
